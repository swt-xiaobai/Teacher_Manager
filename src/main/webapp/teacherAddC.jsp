...
<!-- 添加return-btn类到返回按钮 -->
<a href="information.jsp?account=<%= account%>" class="return-btn">
...
<table class="course-table">
    ...
    <tbody>
        ...
        try{
            ...
            for (course y : list ){
                if(y.getTeacher() ==null ||y.getTeacher().equals("")||y.getTeacher().equals(null)){
        %>
        <tr>
            <td><%= y.getName()%></td>
            <td><%=y.getTime() %></td>
            ...
            <td>
                <a href="cat?name=<%=name %>&account=<%=account %>&course=<%=y.getName()%>">添加</a>
            </td>
        </tr>
        <% 
                }
